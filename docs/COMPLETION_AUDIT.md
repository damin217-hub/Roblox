...
| Five-round, 75-second loop | `Config.ROUNDS_PER_MATCH`, `Config.DRAWING_SECONDS`, Studio smoke assertions |
...
The local release is therefore a verified release candidate, not yet a publicly deployed game.
